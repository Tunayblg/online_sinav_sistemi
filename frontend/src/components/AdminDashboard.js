...
function AdminDashboard({ user, onLogout }) {
  const [activeMenu, setActiveMenu] = useState('dersler')
  ...
  return React.createElement('div', { className: 'admin-container' },
    ...
    React.createElement('div', { className: 'admin-sidebar' },
      ...
      React.createElement('div', { className: 'sidebar-header' },
        ...
        React.createElement('h2', { className: 'welcome-text' }, 'Hoş geldiniz!'),
    ...
    React.createElement('div', { className: 'admin-content' },
      activeMenu === 'dersler' && React.createElement(Lessons),
      activeMenu === 'kullanicilar' && React.createElement(Users)
    )
  )
}
